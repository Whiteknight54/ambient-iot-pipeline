...
METRICS_OUT  = repo_root / "docs" / "evaluation" / "aiot_metrics_aws_stress.json"
...
def run() -> None:
    ...
    print("\n" + "=" * 60)
    print("  AMBIENT IoT PIPELINE - AWS IoT Core [Stress Test]")
    print("=" * 60)
    ...
    print("\n" + "=" * 60)
    print("  AWS PIPELINE RUN SUMMARY [Stress Test]")
    print("=" * 60)
